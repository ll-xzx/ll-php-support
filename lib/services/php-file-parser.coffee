...
module.exports =
    ...
    getFullClassName: (editor, className = null, noCurrent = false) ->
        ...
        if not found
            ...
            methodsRequest = proxy.methods(fullClass, editor)
            ...
            if not bestMatch
                ...
                if null != matches
                    ...
                    if funcName and funcName.length > 0
                        params = proxy.docParams(@getFullClassName(editor), funcName, editor)
    ...
    getMemberContext: (editor, term, bufferPosition, calledClass) ->
        ...
        proxy = require '../services/php-proxy.coffee'
        methods = proxy.methods(calledClass, editor)
    ...
    parseElements: (editor, bufferPosition, elements) ->
        ...
        for element in elements
            ...
            if found
                ...
                methods = proxy.autocomplete(className, element, editor)
